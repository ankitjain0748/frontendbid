                            ...
                            <div className="card-body p-6">
                                ...
                                <div className="border-t pt-4">
                                    ...
                                    <div className="flex mt-3 space-x-4">
                                        <button className="btn btn-success btn-sm w-full bg-green-500 text-white py-2 rounded-md">
                                            Add Fund
                                        </button>
                                        <button className="btn btn-danger btn-sm w-full bg-red-500 text-white py-2 rounded-md">
                                            Withdraw Fund
                                        </button>
                                    </div>
                                </div>
